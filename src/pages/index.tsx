...
import { SignIn } from 'src/Store/Reducer/AuthSlice'
          ...
          <Card sx={{ zIndex: 1 }}>
            <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
              ...
              <FormControl fullWidth>
                <InputLabel sx={{ paddingTop: 4 }} htmlFor='auth-login-password'>
                  Password
                </InputLabel>
                <OutlinedInput
                  name='password'
              ...
              >
                <FormControlLabel control={<Checkbox name='showPassword' />} label='Remember Me' />
                <Link passHref href='/'>
                  <LinkStyled onClick={() => setIsForgotPasswordModalOpen(true)}>Forgot Password?</LinkStyled>
                </Link>
              </Box>
              <Button
                fullWidth
